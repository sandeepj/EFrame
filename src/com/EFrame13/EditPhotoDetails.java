...
public class EditPhotoDetails extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // In order to do any transactions with database.. Need to open the database..
       ...
       // selectedPhoto = ss.getSessionSelectedPhoto();
        ...
        final Dialog dialog2 = new Dialog(EditPhotoDetails.this);
	...
	///		if(c!=null)
		...
		//		if(db!=null)
					db.close();
				System.gc();
				Intent i = new Intent(EditPhotoDetails.this, FullPhotoEdit.class);
